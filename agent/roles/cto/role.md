...
- Start: read `soul.md`, read `handoff.md`, scan `mm brain_stats` + `list_active_agents` + `list_projects` before any docs.
- Stop: update `handoff.md` with only what the next CTO needs on cold start.
