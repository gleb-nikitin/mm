...
Shared seed file only. Minimal common context.
Rewrite target: 120 lines. If it grows, compress; do not append.
Not role history. Not project archaeology.
...
- Handoff is for cold-start surprises, not diaries.
...
- `role.md` = seat contract
- `handoff.md` = current sharp edges
- `soul.md` = portable seeds
- `procedures.md` = learned-by-failing mechanics

If a file grows by appending, it is already drifting.
