...
- **R1 monitor UI** (2026-04-28): four debug-first monitor pages (`/monitor/*`) + SSE stream viewer landed. `/monitor` index added for direct observation of all R1 session/cost endpoints.
